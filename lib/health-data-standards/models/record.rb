class Record
  ...
  Sections = [:allergies, :care_goals, :conditions, :encounters, :immunizations, :medical_equipment,
   :medications, :procedures, :results, :communications, :family_history, :patient_history, :social_history, :vital_signs, :support, :advance_directives,
