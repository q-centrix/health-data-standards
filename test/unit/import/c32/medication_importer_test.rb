...
class MedicationImporterTest < Minitest::Test
  ...
  def test_medication_importing
    ...
    assert_equal '127945006', medication.anatomical_approach['code']
    assert_equal 'SNOMED-CT', medication.anatomical_approach['codeSystem']
